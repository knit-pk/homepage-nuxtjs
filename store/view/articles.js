import { types as categoriesTypes } from '~/store/view/categories'
...
export const getters = {
  ...
  categoryArticlesCodeList: (state, getters) => getters.categories.currentCategoryCode === settings.mainListName ? state.mainList : state.byCategory[getters.categories.currentCategoryCode],
...
export const actions = {
  ...
  getCategoryArticlesList: composer.compose({
    ...
    always: [
      opus.call(({ ctx, params }) => ctx.commit('view/categories/CHANGE_CURRENT_CATEGORY_CODE', { currentCategory: params.categoryCode }, { root: true })),
    ],
    ...
    always: [
      opus.call(({ ctx, params }) => {
        if (params.code !== ctx.getters['currentArticleCode']) {
          ctx.commit('view/categories/CHANGE_CURRENT_CATEGORY_CODE', { currentCategory: params.categoryCode }, { root: true })
        }
      }),
    ],
